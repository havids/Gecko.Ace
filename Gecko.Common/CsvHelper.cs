...
namespace Gecko.Common
{
    public class CsvHelper
    {
        ...
        public static void ReportToCsv(DataTable dt, string fileName, bool isRowOneHeader = true)
        {
            ...
            HttpContext.Current.Response.Write(DatatableToString(dt, isRowOneHeader));
