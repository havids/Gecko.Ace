...
namespace Gecko.Common
{
    ...
    {
        public static string connString = ConfigurationManager.ConnectionStrings["ConnectionString"] == null ? (ConfigurationManager.ConnectionStrings["GeckodaiConnStr"] == null ? "" : ConfigurationManager.ConnectionStrings["GeckodaiConnStr"].ConnectionString) : ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        private static string DefaultResourceServerRoot = "http://static.Gecko.com";
        ...
        public static string DoMain {
            get {
                ...
                if (string.IsNullOrEmpty(url))
                {
                    url = "http://www.Gecko.com";
                }
                return url;
            }
        }
        public static int GeckoLccpRootID
        {
            get
            {
                return 29254;
        ...
        /// 网贷平台 在wiki表中的 根ID
        /// </summary>
        public static int GeckoWikiRootID
        {
            get
            {
                return 1;
        ...
        public static int GeckoLicaiRootID
        {
            get 
            {
                return 24176;
        ...
        /// 银行理财 在wiki表中的 根ID
        /// </summary>
        public static int GeckoYinhangRootID
        {
            get
            {
                return 42021;
        ...
        /// </summary>
        public static int GeckoHelpRootID
        {
            get
            {
                return 3554;
        ...
        public static string StaticRoot
        {
            get
            {
                string url = Utils.ParseString(ConfigurationManager.AppSettings["StaticRoot"], "http://www.Gecko.com/");
                return url;
            }
        }
        ...
        public static string MisDomain = "http://mis.Geckodai.com/";
        public static string ImgDomain = "http://img.Gecko.com/";
        public static string StaticDomain = "http://static.Gecko.com";
        public static string ConfigDomain = "http://config.Gecko.com";
        ...
        public const string SessionFix = "@!!__Gecko_20160125";
        ...
        public const string GeckoSignKey = "Geckolianlian-axax"; 
        ...
        public static string ConnGecko = GetConn("ConnectionString");
        public static string ConnGecko2016 = GetConn("ConnectionStringNew");
        public static string ConnGeckoMis = GetConn("MisConnectionString");
        public static string ConnGeckoTj = GetConn("TjConnectionString");
        public static string ConnGeckoExt = GetConn("ExtConnectionString");
        public static string ConnGeckoBBS = GetConn("BBSConnectionString");
        public static string ConnGeckoApp = GetConn("GeckoApp");
        public static string ConnGeckoSpider = GetConn("SpiderServerCon");
        ...
        public static string CookieDomain
        {
            get
            {
                string url = Utils.ParseString(ConfigurationManager.AppSettings["cookiedomain"], "www.Gecko.com");

                try
                {
                    if (System.Web.HttpContext.Current != null && !string.IsNullOrEmpty(System.Web.HttpContext.Current.Request.Url.Authority))
                    {
                        if (System.Web.HttpContext.Current.Request.Url.Authority.IndexOf("Geckodai.com") > -1)
                            url = "www.Gecko.com";
                    }
                }
                catch
